...
docker run -dt --rm --name ssserver-obfs -p 8443:8443  mritd/shadowsocks -m "ss-server" -s "-s 0.0.0.0 -p 8443 -m chacha20-ietf -k Passw0rd --plugin obfs-server --plugin-opts obfs=tls"
